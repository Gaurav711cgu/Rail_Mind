...
app.include_router(
    trains.router, prefix=f"{settings.API_V1_STR}/trains", tags=["Trains"]
)
app.include_router(
    disruptions.router,
    prefix=f"{settings.API_V1_STR}/disruptions",
    tags=["Disruptions"],
)
app.include_router(
    cascade.router, prefix=f"{settings.API_V1_STR}/cascade", tags=["Cascade"]
)
app.include_router(
    rerouting.router, prefix=f"{settings.API_V1_STR}/rerouting", tags=["Rerouting"]
)
app.include_router(
    rac.router, prefix=f"{settings.API_V1_STR}/rac", tags=["RAC Predictor"]
)
...
app.include_router(
    stream.router, prefix=f"{settings.API_V1_STR}/stream", tags=["Stream SSE"]
)
