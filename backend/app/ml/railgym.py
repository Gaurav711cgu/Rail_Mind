...
class RailGym(gym.Env):
    ...
    def __init__(self, scenario: str = "normal", render_mode=None):
        ...
        self.action_space = spaces.MultiDiscrete(
            [self.N_ACTIONS_PER_SECTION] * self.N_SECTIONS
        )
    ...
    def _generate_initial_state(self) -> Dict[str, Any]:
        ...
        for _ in range(self.N_SECTIONS):
            ...
            sections.append({
                ...
                "weather_visibility": 1.0 if cfg.get("weather") != "FOG" else float(self.np_random.uniform(0.1, 0.5)),
            })
    ...
    def _advance_simulation(self) -> Tuple[float, Dict[str, Any]]:
        ...
        reward = (
            -total_passenger_delay * 1.0
            - total_freight_delay * 0.3
            - safety_violations * 10000.0
        )
